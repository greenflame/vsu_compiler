...
// $ANTLR 3.5.2 c.g 2015-10-05 18:28:55
...
public partial class cParser : Antlr.Runtime.Parser
{
	...
	// c.g:77:1: value_group : ( '(' ! value_add ')' !| NUMBER | STRING | ID | LOGIC );
	...
	private AstParserRuleReturnScope<object, IToken> value_group()
	{
		...
		try
		{
			// c.g:78:2: ( '(' ! value_add ')' !| NUMBER | STRING | ID | LOGIC )
			int alt1=5;
	...
	// c.g:81:1: value_mult : value_group ( ( MUL | DIV ) ^ value_group )* ;
	...
	private AstParserRuleReturnScope<object, IToken> value_mult()
	{
		...
		try
		{
			// c.g:82:2: ( value_group ( ( MUL | DIV ) ^ value_group )* )
			DebugEnterAlt(1);
			// c.g:82:4: value_group ( ( MUL | DIV ) ^ value_group )*
			{
			root_0 = (object)adaptor.Nil();
	...
	// c.g:85:1: value_add : value_mult ( ( ADD | SUB ) ^ value_mult )* ;
	...
	private AstParserRuleReturnScope<object, IToken> value_add()
	{
		...
		try
		{
			// c.g:86:2: ( value_mult ( ( ADD | SUB ) ^ value_mult )* )
			DebugEnterAlt(1);
			// c.g:86:4: value_mult ( ( ADD | SUB ) ^ value_mult )*
			{
			root_0 = (object)adaptor.Nil();
	...
	// c.g:90:1: logic_group : value_add ( ( GE | LE | NEQUALS | EQUALS | GT | LT ) ^ value_add )? ;
	...
	private AstParserRuleReturnScope<object, IToken> logic_group()
	{
		...
		try
		{
			// c.g:92:2: ( value_add ( ( GE | LE | NEQUALS | EQUALS | GT | LT ) ^ value_add )? )
			DebugEnterAlt(1);
			// c.g:92:4: value_add ( ( GE | LE | NEQUALS | EQUALS | GT | LT ) ^ value_add )?
			{
			root_0 = (object)adaptor.Nil();
			...
			DebugLocation(92, 14);
			// c.g:92:14: ( ( GE | LE | NEQUALS | EQUALS | GT | LT ) ^ value_add )?
			int alt4=2;
			...
			case 1:
				DebugEnterAlt(1);
				// c.g:92:16: ( GE | LE | NEQUALS | EQUALS | GT | LT ) ^ value_add
				{
				DebugLocation(92, 56);
	...
	// c.g:95:1: logic_mult : logic_group ( LMUL ^ logic_group )* ;
	...
	private AstParserRuleReturnScope<object, IToken> logic_mult()
	{
		...
		try
		{
			// c.g:96:2: ( logic_group ( LMUL ^ logic_group )* )
			DebugEnterAlt(1);
			// c.g:96:4: logic_group ( LMUL ^ logic_group )*
			{
			root_0 = (object)adaptor.Nil();
	...
	// c.g:99:1: logic_add : logic_mult ( LADD ^ logic_mult )* ;
	...
	private AstParserRuleReturnScope<object, IToken> logic_add()
	{
		...
		try
		{
			// c.g:100:2: ( logic_mult ( LADD ^ logic_mult )* )
			DebugEnterAlt(1);
			// c.g:100:4: logic_mult ( LADD ^ logic_mult )*
			{
			root_0 = (object)adaptor.Nil();
	...
	// $ANTLR start "assign"
	// c.g:104:1: assign : ID ASSIGN ^ logic_add ;
	[GrammarRule("assign")]
	private AstParserRuleReturnScope<object, IToken> assign()
	{
		...
		try
		{
			// c.g:105:2: ( ID ASSIGN ^ logic_add )
			DebugEnterAlt(1);
			// c.g:105:4: ID ASSIGN ^ logic_add
			{
			root_0 = (object)adaptor.Nil();
	...
	// c.g:108:1: assign_list : ( assign ( ',' assign )* )? -> ^( BLOCK ( assign )* ) ;
	...
	private AstParserRuleReturnScope<object, IToken> assign_list()
	{
		...
		try
		{
			// c.g:109:2: ( ( assign ( ',' assign )* )? -> ^( BLOCK ( assign )* ) )
			DebugEnterAlt(1);
			// c.g:109:4: ( assign ( ',' assign )* )?
			{
			DebugLocation(109, 4);
			// c.g:109:4: ( assign ( ',' assign )* )?
			int alt8=2;
	...
	// $ANTLR start "expr"
	// c.g:112:1: expr : ( '{' ! expr_list '}' !| assign ';' !| READ ^ '(' ! ID ( ',' ! ID )* ');' !| WRITE ^ '(' ! logic_add ( ',' ! logic_add )* ');' !| IF ^ '(' ! logic_add ')' ! expr ( ELSE ! expr )? | FOR '(' assign_list ';' logic_add ';' assign_list ')' expr -> ^( FOR assign_list logic_add assign_list expr ) );
	[GrammarRule("expr")]
	private AstParserRuleReturnScope<object, IToken> expr()
	{
		...
		try
		{
			// c.g:113:2: ( '{' ! expr_list '}' !| assign ';' !| READ ^ '(' ! ID ( ',' ! ID )* ');' !| WRITE ^ '(' ! logic_add ( ',' ! logic_add )* ');' !| IF ^ '(' ! logic_add ')' ! expr ( ELSE ! expr )? | FOR '(' assign_list ';' logic_add ';' assign_list ')' expr -> ^( FOR assign_list logic_add assign_list expr ) )
			int alt12=6;
			...
			case 4:
				DebugEnterAlt(4);
				// c.g:118:4: WRITE ^ '(' ! logic_add ( ',' ! logic_add )* ');' !
				{
				root_0 = (object)adaptor.Nil();
			...
			case 5:
				DebugEnterAlt(5);
				// c.g:120:4: IF ^ '(' ! logic_add ')' ! expr ( ELSE ! expr )?
				{
				root_0 = (object)adaptor.Nil();
			...
			case 6:
				DebugEnterAlt(6);
				// c.g:121:4: FOR '(' assign_list ';' logic_add ';' assign_list ')' expr
				{
				DebugLocation(121, 4);
				...
				{
				// AST REWRITE
				// elements: logic_add, expr, FOR, assign_list, assign_list
				// token labels: 
				// rule labels: retval
				// token list labels: 
				// rule list labels: 
				...
				// 121:63: -> ^( FOR assign_list logic_add assign_list expr )
				{
					...
					// c.g:121:66: ^( FOR assign_list logic_add assign_list expr )
					{
					object root_1 = (object)adaptor.Nil();
	...
	// c.g:124:1: expr_list : ( expr )* -> ^( BLOCK ( expr )* ) ;
		...
		try
		{
			...
			while (true)
			{
				...
				case 1:
					...
					{
					DebugLocation(125, 4);
					PushFollow(Follow._expr_in_expr_list804);
					expr62=expr();
					PopFollow();
	...
	// $ANTLR start "result"
	// c.g:128:1: result : expr_list EOF -> ^( PROGRAM expr_list ) ;
	[GrammarRule("result")]
	private AstParserRuleReturnScope<object, IToken> result()
	{
		...
		try
		{
			// c.g:129:2: ( expr_list EOF -> ^( PROGRAM expr_list ) )
			DebugEnterAlt(1);
			// c.g:129:4: expr_list EOF
			{
			DebugLocation(129, 4);
			PushFollow(Follow._expr_list_in_result826);
			expr_list63=expr_list();
			PopFollow();

			stream_expr_list.Add(expr_list63.Tree);
			DebugLocation(129, 14);
			EOF64=(IToken)Match(input,EOF,Follow._EOF_in_result828);  
	...
	// $ANTLR start "execute"
	// c.g:132:8: public execute : result ;
	[GrammarRule("execute")]
	public AstParserRuleReturnScope<object, IToken> execute()
	{
		...
		try
		{
			...
			DebugLocation(133, 4);
			PushFollow(Follow._result_in_execute851);
			result65=result();
			PopFollow();
	...
	{
		public static readonly BitSet _31_in_value_group430 = new BitSet(new ulong[]{0x88842000UL});
		public static readonly BitSet _value_add_in_value_group433 = new BitSet(new ulong[]{0x100000000UL});
		public static readonly BitSet _32_in_value_group435 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _NUMBER_in_value_group440 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _STRING_in_value_group444 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _ID_in_value_group448 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _LOGIC_in_value_group452 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _value_group_in_value_mult464 = new BitSet(new ulong[]{0x200082UL});
		public static readonly BitSet _set_in_value_mult468 = new BitSet(new ulong[]{0x88842000UL});
		public static readonly BitSet _value_group_in_value_mult479 = new BitSet(new ulong[]{0x200082UL});
		public static readonly BitSet _value_mult_in_value_add494 = new BitSet(new ulong[]{0x10000012UL});
		public static readonly BitSet _set_in_value_add498 = new BitSet(new ulong[]{0x88842000UL});
		public static readonly BitSet _value_mult_in_value_add509 = new BitSet(new ulong[]{0x10000012UL});
		public static readonly BitSet _value_add_in_logic_group526 = new BitSet(new ulong[]{0x491A02UL});
		public static readonly BitSet _set_in_logic_group530 = new BitSet(new ulong[]{0x88842000UL});
		public static readonly BitSet _value_add_in_logic_group557 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _logic_group_in_logic_mult572 = new BitSet(new ulong[]{0x20002UL});
		public static readonly BitSet _LMUL_in_logic_mult576 = new BitSet(new ulong[]{0x88842000UL});
		public static readonly BitSet _logic_group_in_logic_mult579 = new BitSet(new ulong[]{0x20002UL});
		public static readonly BitSet _logic_mult_in_logic_add593 = new BitSet(new ulong[]{0x8002UL});
		public static readonly BitSet _LADD_in_logic_add597 = new BitSet(new ulong[]{0x88842000UL});
		public static readonly BitSet _logic_mult_in_logic_add600 = new BitSet(new ulong[]{0x8002UL});
		public static readonly BitSet _ID_in_assign614 = new BitSet(new ulong[]{0x20UL});
		public static readonly BitSet _ASSIGN_in_assign616 = new BitSet(new ulong[]{0x88842000UL});
		public static readonly BitSet _logic_add_in_assign619 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _assign_in_assign_list633 = new BitSet(new ulong[]{0x400000002UL});
		public static readonly BitSet _34_in_assign_list637 = new BitSet(new ulong[]{0x2000UL});
		public static readonly BitSet _assign_in_assign_list639 = new BitSet(new ulong[]{0x400000002UL});
		public static readonly BitSet _36_in_expr665 = new BitSet(new ulong[]{0x3022006400UL});
		public static readonly BitSet _expr_list_in_expr668 = new BitSet(new ulong[]{0x2000000000UL});
		public static readonly BitSet _37_in_expr670 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _assign_in_expr678 = new BitSet(new ulong[]{0x800000000UL});
		public static readonly BitSet _35_in_expr680 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _READ_in_expr688 = new BitSet(new ulong[]{0x80000000UL});
		public static readonly BitSet _31_in_expr691 = new BitSet(new ulong[]{0x2000UL});
		public static readonly BitSet _ID_in_expr694 = new BitSet(new ulong[]{0x600000000UL});
		public static readonly BitSet _34_in_expr698 = new BitSet(new ulong[]{0x2000UL});
		public static readonly BitSet _ID_in_expr701 = new BitSet(new ulong[]{0x600000000UL});
		public static readonly BitSet _33_in_expr705 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _WRITE_in_expr711 = new BitSet(new ulong[]{0x80000000UL});
		public static readonly BitSet _31_in_expr714 = new BitSet(new ulong[]{0x88842000UL});
		public static readonly BitSet _logic_add_in_expr717 = new BitSet(new ulong[]{0x600000000UL});
		public static readonly BitSet _34_in_expr721 = new BitSet(new ulong[]{0x88842000UL});
		public static readonly BitSet _logic_add_in_expr724 = new BitSet(new ulong[]{0x600000000UL});
		public static readonly BitSet _33_in_expr728 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _IF_in_expr736 = new BitSet(new ulong[]{0x80000000UL});
		public static readonly BitSet _31_in_expr739 = new BitSet(new ulong[]{0x88842000UL});
		public static readonly BitSet _logic_add_in_expr742 = new BitSet(new ulong[]{0x100000000UL});
		public static readonly BitSet _32_in_expr744 = new BitSet(new ulong[]{0x1022006400UL});
		public static readonly BitSet _expr_in_expr747 = new BitSet(new ulong[]{0x102UL});
		public static readonly BitSet _ELSE_in_expr751 = new BitSet(new ulong[]{0x1022006400UL});
		public static readonly BitSet _expr_in_expr754 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _FOR_in_expr762 = new BitSet(new ulong[]{0x80000000UL});
		public static readonly BitSet _31_in_expr764 = new BitSet(new ulong[]{0x800002000UL});
		public static readonly BitSet _assign_list_in_expr766 = new BitSet(new ulong[]{0x800000000UL});
		public static readonly BitSet _35_in_expr768 = new BitSet(new ulong[]{0x88842000UL});
		public static readonly BitSet _logic_add_in_expr770 = new BitSet(new ulong[]{0x800000000UL});
		public static readonly BitSet _35_in_expr772 = new BitSet(new ulong[]{0x100002000UL});
		public static readonly BitSet _assign_list_in_expr774 = new BitSet(new ulong[]{0x100000000UL});
		public static readonly BitSet _32_in_expr776 = new BitSet(new ulong[]{0x1022006400UL});
		public static readonly BitSet _expr_in_expr778 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _expr_in_expr_list804 = new BitSet(new ulong[]{0x1022006402UL});
		public static readonly BitSet _expr_list_in_result826 = new BitSet(new ulong[]{0x0UL});
		public static readonly BitSet _EOF_in_result828 = new BitSet(new ulong[]{0x2UL});
		public static readonly BitSet _result_in_execute851 = new BitSet(new ulong[]{0x2UL});
	}
